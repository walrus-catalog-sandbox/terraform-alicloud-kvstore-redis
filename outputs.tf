...
output "endpoint_internal" {
  ...
  value       = [var.infrastructure.domain_suffix == null ? format("%s:6379", alicloud_kvstore_instance.default.connection_domain) : format("%s.%s:6379", alicloud_pvtz_zone_record.default[0].rr, var.infrastructure.domain_suffix)]
}
