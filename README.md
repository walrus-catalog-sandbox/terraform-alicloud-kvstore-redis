...
| <a name="input_engine_parameters"></a> [engine\_parameters](#input\_engine\_parameters) | Specify the deployment parameters. See https://www.alibabacloud.com/help/zh/redis/user-guide/supported-parameters#concept-2087327. | <pre>list(object({<br>    name  = string<br>    value = string<br>  }))</pre> | `null` | no |
